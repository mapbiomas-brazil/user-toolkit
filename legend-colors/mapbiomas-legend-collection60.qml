  ...
  <pipe>
    <rasterrenderer band="1" alphaBand="-1" opacity="1" type="paletted">
      ...
      <colorPalette>
        ...
        <paletteEntry label="36 - Lavoura Perene" color="#f3b4f1" value="36" alpha="255"/>
        <paletteEntry label="39 - Soja" color="#e075ad" value="39" alpha="255"/>
        <paletteEntry label="40 - Arroz (beta)" color="#982c9e" value="40" alpha="255"/>
        <paletteEntry label="41 - Outras Lavouras Temporárias" color="#e787f8" value="41" alpha="255"/>
      </colorPalette>
